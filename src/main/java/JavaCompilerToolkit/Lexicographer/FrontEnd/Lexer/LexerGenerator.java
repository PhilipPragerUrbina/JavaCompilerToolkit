...
import JavaCompilerToolkit.Lexicographer.FrontEnd.JavaGenerator;
...
public class LexerGenerator extends JavaGenerator {
     ...
     * @param lexer_specification Tokens to generate
     * @param language_name Name of language Lexer is for
     * @param package_name Name of package that code will be part of
     */
    public LexerGenerator(LexerSpecification lexer_specification, String language_name, String package_name){
        super( package_name,  "java.util.ArrayList", "java.util.Comparator","java.util.regex.Matcher","java.util.regex.Pattern", "JavaCompilerToolkit.Lexicographer.FrontEnd.Lexer.*"); //Import libraries
        ArrayList<TokenSpecification> specifications = lexer_specification.getSpecifications();
